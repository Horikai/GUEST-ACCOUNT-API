#API CREDIT BY @senku_codex @raihanpaid @DANGER_FF_LIKE
...
def generate_custom_password():
    ...
    return f"LUANORI-{random_part}-DEV"
...
def generate_accounts():
    # Get parameters
    name = request.args.get('name', 'LuanOri')
    ...
    response_data = {
        ...
        "credit": {
            ...
            "note": "FREE TOOL - Keep This Credit Please 🎉",
            "version": "FULL_LOGIN 2025-2026"
        }
    }
...
def home():
    info = {
        "message": "FreeFire FULL LOGIN Account Generator API",
        "description": "Tạo tài khoản Free Fire hoàn chỉnh (full login) tự động",
        "endpoint": "/gen",
        "usage_example": "http://your-ip:3000/gen?name=LuanOri&count=5&region=VN",
        "parameters": {
            "name": "Tiền tố tên nhân vật (mặc định: LuanOri)",
            "count": "Số lượng acc cần tạo (tối đa 15, mặc định 1)",
        ...
        "credit": {
            "author": "@LuanOri04 @ShiinaTenju @ShiinaTenju_Bot",
            "note": "Use for FREE 🎉 | Vui lòng giữ nguyên credit",
            "year": "2025-2026"
        }
    }
